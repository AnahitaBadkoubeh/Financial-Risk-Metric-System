...
os.chdir(cwd)
from RiskModel import PortfolioRiskMetrics

risk_report_final = PortfolioRiskMetrics(tickers, alpha, trade_horizon, capital, start_day, historical_horizon)

risk_report_final.generate_risk_report()